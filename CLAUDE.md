...
`cg-`/`consent-gate` CSS classes and enqueue handles, `wp consent-gate` CLI.
Never "finish" the rename into those internals — the option name and hook
names are live site data and public API. The i18n bridge strings ($t()) are
