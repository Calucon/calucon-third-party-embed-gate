# Customizing Third-Party Embed Gate
...
Third-Party Embed Gate's entire product is: **nothing third-party loads before the
...
- **Don't** load a preview image, poster, or favicon from the provider in a
  ...
  **Set poster image** control (Third-Party Embed Gate panel in the block inspector)
...
disable that provider under **Providers** — Third-Party Embed Gate then passes its
